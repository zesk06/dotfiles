...
c.InteractiveShellApp.exec_lines.append('print("Warning: autoreload activated")')

c.InteractiveShellApp.exec_lines.append('import logging')
c.InteractiveShellApp.exec_lines.append('logging.getLogger("parso").setLevel(logging.INFO)')
...
#c.InteractiveShell.banner1 = 'Python 2.7.5 (default, Apr  9 2019, 14:30:50) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.8.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
